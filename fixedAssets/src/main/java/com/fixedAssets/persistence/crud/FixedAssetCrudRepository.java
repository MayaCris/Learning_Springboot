...
public interface FixedAssetCrudRepository extends CrudRepository<FixedAsset, Integer> {
    ...
    Optional<List<FixedAsset>> findByPersonIdOrderByAssetNameAsc(String personId); //Esto tambien se puede hacer con Query nativa: Pero no se por que no funciona 🤦‍♂️
