...
EXECUTE ADD_ASSET_TYPE('CONSTRUCCIONES Y EDIFICACIONES',540);
EXECUTE ADD_ASSET_TYPE('FLOTA Y EQUIPO AEREO',360);
EXECUTE ADD_ASSET_TYPE('FLOTA Y EQUIPO DE TRANSPORTE TERRRESTRE',120)
EXECUTE ADD_ASSET_TYPE('MAQUINARIA Y EQUIPOS',120);
EXECUTE ADD_ASSET_TYPE('MUEBLES Y ENSERES',120);
EXECUTE ADD_ASSET_TYPE('EQUIPO DE COMPUTACION',60);
EXECUTE ADD_ASSET_TYPE('EQUIPO DE COMUNICACION',60);
